			...
			handleMove(detail) {
				...
				if(this.direction!='vertical') {
					if(this.infoAlign=='left') {
						...
						// #endif
						// #ifdef APP-NVUE
						percent = (detail.pageX -this.screenLeft  - handleWidth[0]/2)/ this.barMaxLength
						// #endif
					}
					else {
						// #ifndef APP-NVUE
					...
					// #ifdef APP-NVUE
					percent = 1 - (detail.pageY -this.screenLeft - handleWidth[0]/2- 1) / this.barMaxLength
					// #endif
					// #ifndef APP-NVUE
