 ...
 *
 * **/
export default class zcAudio extends EventBus {
    ...
    private init;
    checkEventParams(event: zcaudioCbName, action: string | symbol, fn?: () => {}): boolean;
    /**
     ...
     * @returns undefined
     * **/
    off(event: zcaudioCbName, action: string | symbol): void;
    /**
     ...
     * @returns undefined
     * **/
    on(event: zcaudioCbName, action: string | symbol, fn: () => {}): void;
    /**
     ...
     * @returns undefined
     * **/
    emit(event: zcaudioCbName, data?: any): void;
    private commit;
